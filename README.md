...
### 一、项目演示地址（点击链接就可以看到）：
https://www.bilibili.com/video/BV1HfAjeEEst/?spm_id_from=333.1387.search.video_card.click&vd_source=c01eb631d21f3b1ec41e350c824e10cc

### 二、获取地址:

### 项目获取地址：https://www.666bear.com/9978.html
...
基于微信小程序的智能化的房屋营销推荐系统

角色：管理员、用户

管理员：管理员登录到智能化的房屋营销推荐系统可以查看系统首页、用户、房屋类型、房屋信息、销售订单、系统管理、个人资料等功能进行详细操作，

用户：当用户打开微信小程序的网址后，首先看到的就是微信小程序首页界面。在这里，用户能够看到智能化的房屋营销推荐系统微信小程序的导航条显示首页、房屋信息、我的等
